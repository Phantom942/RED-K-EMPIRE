...
- [x] Balises meta, Open Graph, Twitter Card
- [x] URL canonique
- [x] JSON-LD (`RealEstateAgent` + `WebSite`)
...
- [ ] Mentions légales : SIRET, adresse, directeur de publication
- [ ] Politique de confidentialité : durées de conservation, DPO si applicable
- [ ] Email domaine `@redkempire.fr` si migration prévue
